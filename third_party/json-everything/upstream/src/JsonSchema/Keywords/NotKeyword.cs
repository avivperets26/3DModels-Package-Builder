...
/// </summary>
/// <remarks>
/// This keyword specifies that an instance must not be valid against the subschema.
/// </remarks>
public class NotKeyword : IKeywordHandler
{
	/// <summary>
	/// Gets the singleton instance of the <see cref="NotKeyword"/>.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="NotKeyword"/> class.
	/// </summary>
