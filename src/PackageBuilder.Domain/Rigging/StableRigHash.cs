...
internal struct StableRigHash
{
    private const uint OffsetBasis = 2166136261u;
    private const uint Prime = 16777619u;
    private uint _value;

    public static StableRigHash Create() => new() { _value = OffsetBasis };

    public StableRigHash Add(double value)
    {
    ...
    public StableRigHash Add(long value)
    {
    ...
    public StableRigHash Add(string value)
    {
