...
$expectedFiles = @(
    ...
    'Editor/UnitySkinSkeletonValidator.cs',
    ...
    'Editor/UnityItemPrefabGenerator.cs',
    'Editor/UnityAssembledSetGenerator.cs',
    'Editor/Shared/AttachmentPolicy.cs',
    'Editor/Shared/OverviewLayoutPolicy.cs',
    'Editor/UnitySetAttachmentValidator.cs',
    ...
    'Editor/UnityTwelveItemCollectionIntegration.cs',
