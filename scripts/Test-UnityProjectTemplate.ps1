...
$expectedWorkerPackageFiles = @(
    ...
    'Packages/com.packagebuilder.worker/Editor/UnityRigModelImporterPolicy.cs',
    'Packages/com.packagebuilder.worker/Editor/UnitySkinSkeletonValidator.cs',
    ...
    'Packages/com.packagebuilder.worker/Editor/UnityAssembledSetGenerator.cs',
    'Packages/com.packagebuilder.worker/Editor/Shared/AttachmentPolicy.cs',
    'Packages/com.packagebuilder.worker/Editor/Shared/OverviewLayoutPolicy.cs',
    'Packages/com.packagebuilder.worker/Editor/UnitySetAttachmentValidator.cs',
    ...
    'Packages/com.packagebuilder.worker/Editor/UnityFabReleaseInspection.cs',
